...
const sampleMultiSelectExercise: ExerciseDefinition = {
  ...
  options: [
    { id: 'opt_a', text: 'А', isCorrect: true, explanation: 'Masculine back vowel.' },
    { id: 'opt_o', text: 'О', isCorrect: true, explanation: 'Masculine back vowel.' },
    { id: 'opt_u', text: 'У', isCorrect: true, explanation: 'Masculine back vowel.' },
    { id: 'opt_e', text: 'Э', isCorrect: false, explanation: 'Feminine front vowel.' },
    { id: 'opt_oe', text: 'Ө', isCorrect: false, explanation: 'Feminine front vowel.' },
  ],
  correctAnswer: 'А, О, У',
