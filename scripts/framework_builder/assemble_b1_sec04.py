"""
Assemble and validate B1 Section 04 lesson blueprint.
"""

import json
import sys
from author_sec04_part1 import get_sec04_part1_lessons
from author_sec04_part2 import get_sec04_part2_lessons
from author_sec04_part3 import get_sec04_part3_lessons
from author_sec04_part4 import get_sec04_part4_lessons

def main():
    lessons = []
    lessons.extend(get_sec04_part1_lessons())
    lessons.extend(get_sec04_part2_lessons())
    lessons.extend(get_sec04_part3_lessons())
    lessons.extend(get_sec04_part4_lessons())

    print(f"Total Section 04 lessons assembled: {len(lessons)}")
    assert len(lessons) == 47, f"Expected 47 lessons, got {len(lessons)}"
    ...
    # Check budget reconciliation for units 145 to 155
    for u in b1_units[33:]:
        uid = u["unitId"]
    ...
    # Write out b1_section_04.json
    out_path = "curriculum/lesson_blueprints/b1_section_04.json"
