"""
Assemble and validate B1 Section 02 lesson blueprint.
"""

import json
import sys
from author_sec02_part1 import get_sec02_part1_lessons
from author_sec02_part2 import get_sec02_part2_lessons
from author_sec02_part3 import get_sec02_part3_lessons
from author_sec02_part4 import get_sec02_part4_lessons

def main():
    lessons = []
    lessons.extend(get_sec02_part1_lessons())
    lessons.extend(get_sec02_part2_lessons())
    lessons.extend(get_sec02_part3_lessons())
    lessons.extend(get_sec02_part4_lessons())

    print(f"Total Section 02 lessons assembled: {len(lessons)}")
    assert len(lessons) == 48, f"Expected 48 lessons, got {len(lessons)}"
    ...
    # Check budget reconciliation for units 124 to 134
    for u in b1_units[12:23]:
        uid = u["unitId"]
    ...
    # Write out b1_section_02.json
    out_path = "curriculum/lesson_blueprints/b1_section_02.json"
