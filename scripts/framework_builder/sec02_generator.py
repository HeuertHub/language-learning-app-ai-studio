"""
Full Section 02 Generator
Generates all 58 lessons for Units 24 through 33.
"""

import json

def get_section_02_data():
    ...
    # =========================================================================
    # UNIT 24: Existential Assertion: Байна vs Байхгүй (6 lessons)
    # Targets: ProdLem=17, RecLem=6, ProdExp=4, RecExp=2
    # Budget split:
    # L1: 5, 2, 1, 1 (Grammar intro)
    # L2: 5, 2, 1, 0 (Grammar intro)
    # L3: 4, 1, 1, 1 (Practice)
    # L4: 3, 1, 1, 0 (Reading)
    # L5: 0, 0, 0, 0 (Listening lab - ZERO VOCAB)
    # L6: 0, 0, 0, 0 (Dialogue synthesis - ZERO VOCAB)
    # Sum: 17, 6, 4, 2 -> EXACT
    # =========================================================================
    u = u_map[24]
    uid = u["unitId"]
