"""
Assemble and validate B1 Section 01 lesson blueprint.
"""

import json
import sys
from author_sec01_part1 import get_sec01_part1_lessons
from author_sec01_part2 import get_sec01_part2_lessons
from author_sec01_part3 import get_sec01_part3_lessons
from author_sec01_part4 import get_sec01_part4_lessons

def main():
    lessons = []
    lessons.extend(get_sec01_part1_lessons())
    lessons.extend(get_sec01_part2_lessons())
    lessons.extend(get_sec01_part3_lessons())
    lessons.extend(get_sec01_part4_lessons())

    print(f"Total Section 01 lessons assembled: {len(lessons)}")
    assert len(lessons) == 55, f"Expected 55 lessons, got {len(lessons)}"
    ...
    # Check budget reconciliation for units 112 to 123
    for u in b1_units[:12]:
        uid = u["unitId"]
    ...
    # Write out b1_section_01.json
    out_path = "curriculum/lesson_blueprints/b1_section_01.json"
